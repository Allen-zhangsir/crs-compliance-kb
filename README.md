...
| [香港保单收益要交20%个税吗？（2026年8月最新）](qa/hk-policy-dividend-tax-2026.md) | 分四笔钱、三个层次：理赔金法条层法定免税；分红/退保增值段法理层未定＋执行层个案在征（财新2026-08-05：京杭个案20%、"尚不具普遍性"）；预缴利息依据最扎实。含**香港保监局2026-08-06回应完整两句**与证券时报实地核实结果 |
...
| [GL16首次统一披露的分红实现率怎么读？](qa/gl16-fulfilment-ratio-disclosure-guide.md) | 每年6-30前统一披露、三类红利分列、覆盖2010年起产品；无绝对及格线——三维判读：时间深度×产品口径×自身需求；GL34分红基金隔离是治理保障、非破产隔离 |
